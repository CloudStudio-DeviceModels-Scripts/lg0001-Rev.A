...
function getEndpoints(deviceAddress, endpoints)
{
  ...
  endpoints.addEndpoint("2", "Tonalizador", endpointType.dimmer);
  endpoints.addEndpoint("3", "SensorActivo", endpointType.activePowerSensor);
  endpoints.addEndpoint("4", "Reactivo", endpointType.reactivePowerSensor);
  endpoints.addEndpoint("5", "Poder Aparente", endpointType.apparentPowerSensor);
  endpoints.addEndpoint("6", "Camera", endpointType.camera);
  endpoints.addEndpoint("7", "Cos", endpointType.cosPhiSensor);
  endpoints.addEndpoint("8", "Corriente", endpointType.currentSensor);
  endpoints.addEndpoint("9", "Cortina", endpointType.curtainController);
  endpoints.addEndpoint("10", "Energia", endpointType.energyMeter);
  endpoints.addEndpoint("11", "Fluxo", endpointType.flowSensor);
